...
modelsummary(models, estimate  = "{estimate} [{std.error}] {stars}", statistic = NULL, gof_map = c("nobs", "r.squared"), stars = TRUE, coef_rename = c("gendermale" = "Gender Male", "visMinBlack" = "Race Black", "visMinWhite" = "Race White", "visMinIndigenous" = "Race Indigenous", "visMinAsian" = "Race Asian", "visMinArab" = "Race Arab", "provinceBritish-Columbia" = "British-Columbia", "provinceCanadian Territories" = "Canadian Territories", "provinceOntario" = "Ontario", "provincePrairies (Alberta, Saskatchewan, Manitoba)" = "Prairies (Alberta, Saskatchewan, Manitoba", "provinceQuébec" = "Quebec", "age35-54 years old" = "35-54 years old", "age55 years old or more" = "55+ years old", "educationcollegial/technical" = "College or Technical Education", "educationuniversity" = "University", "incomebetween $40,001 and $100,000" = "Income between $40,001 and $100,000", "incomemore than $100,000" = "Income more than $100 000", "ruralityurban" = "Urban's area of living"),  output = "text.png")
